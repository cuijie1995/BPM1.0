    ...
    <el-main class="fm2-main">
      <el-container>
        <el-container class="center-container" direction="vertical">
          <el-main :class="{'created-empty': createdFormData.dynamicList.length == 0}">
            <ShowForm
              v-if="!resetJson"
              ref="createdFormData"
        ...
        <el-aside class="created-config-container">
          <el-container>
            ...
            <el-main class="config-content">
              <config v-show="configTab=='created'" :data="formDataSelect" :type="formType"></config>
...
export default {
  ...
  methods: {
    ...
    setJSON(json) {
      ...
      if (json.dynamicList.length > 0) {
        this.formDataSelect = json.dynamicList[0];
      }
    },
    handleInput(val) {
      this.blank = val;
  ...
  watch: {
    ...
    editInfo: {
      deep: true,
      handler() {
        if (this.editInfo && this.editInfo.dynamicList) {
          this.createdFormData = { ...this.editInfo };
          this.formDataSelect =
            this.editInfo &&
            this.editInfo.dynamicList.length > 0 &&
            this.editInfo.dynamicList[0];
        }
      }
    }
  }
