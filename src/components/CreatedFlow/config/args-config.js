export const flowConfig = {
  jsPlumbInsConfig: {
    // jsplumb连线的样式  用connector表示，有四种Bezier: 贝塞尔曲线 Flowchart: 具有90度转折点的流程线 StateMachine: 状态机  Straight: 直线
  ...
  jsPlumbConfig: {
    ...
    makeSourceConfig: {
      filter: 'a',
      filterExclude: true,
      maxConnections: 5,//默认值为1，一个端点最多只能拉出一条线，当设置为5时，表示最多一个端点可以拉出5条线，当设置为-1时，表示不限制拉出的线数
      endpoint: ['Dot', { radius: 8 }],//端点类型，形状
