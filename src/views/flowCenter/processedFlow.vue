  ...
  <div class="my_flow">
    ...
    <div class="flow_item">
      ...
      >
        ...
        <el-table-column :label="'流程执行人'" width="120px" align="center">
        ...
        <el-table-column :label="'完成时间'" min-width="120px" align="center">
          <template slot-scope="scope">
            <span>{{scope.row.finishDate | format}}</span>
          </template>
        </el-table-column>

        <el-table-column :label="'节点名称'" min-width="120px" align="center">
          <template slot-scope="scope">
    ...
    seeFlow() {
      if (this.flowId.length == 1) {
        ...
        GetFlowTrackInfo({ id: this.flowId[0].flowInstanceId }).then(res => {
          ...
          this.flowContent.flowNodeMaps.forEach(element => {});
        });
