<template>
  <div class="per_add">
    <el-dialog
      :title="dialogUpdatePersonnelGroup.title"
      :visible.sync="dialogUpdatePersonnelGroup.show"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogUpdatePersonnelGroup.show = false">取 消</el-button>
        <el-button type="primary" @click="updatePersonnelGroup()">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  name: "personnelGroup",
  props: {
    dialogUpdatePersonnelGroup: Object,
    ...
    updatePersonnelGroup() {
      this.$refs["personnelGroupForm"].validate(valid => {
        if (valid) {
          ...
          UpdateRole(this.personnelGroupForm)
            .then(res => {
              this.dialogUpdatePersonnelGroup.show = false;
              this.$parent.getList();
            })
            .catch(err => {
              console.log(err);
